...
import (
	...
	"github.com/xumchain/go-xumchain/internal/jsre"
...
func newTester(t *testing.T, confOverride func(*ethconfig.Config)) *tester {
	...
	// Create a networkless protocol stack and start an Xumchain service within
	...
	if err != nil {
		t.Fatalf("failed to register Xumchain protocol: %v", err)
	}
