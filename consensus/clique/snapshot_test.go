...
// mapped from textual names used in the tests below to actual Xumchain private
...
// address retrieves the Xumchain address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Xumchain address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/xumchain/go-xumchain/issues/17593). Whilst this
