...
// Package graphql provides a GraphQL interface to Xumchain node data.
package graphql
...
// Account represents an Xumchain account at a particular block.
type Account struct {
...
// Transaction represents an Xumchain transaction.
...
// Block represents an Xumchain block.
...
type CallData struct {
	From     *common.Address // The Xumchain address the call is from.
	To       *common.Address // The Xumchain address the call is to.
