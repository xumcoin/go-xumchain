...
import (
	...
	"github.com/xumchain/go-xumchain/common/fdlimit"
	"github.com/xumchain/go-xumchain/consensus"
	"github.com/xumchain/go-xumchain/consensus/clique"
	"github.com/xumchain/go-xumchain/consensus/ethash"
	"github.com/xumchain/go-xumchain/core"
	"github.com/xumchain/go-xumchain/core/rawdb"
	"github.com/xumchain/go-xumchain/core/vm"
	"github.com/xumchain/go-xumchain/crypto"
	"github.com/xumchain/go-xumchain/eth"
	"github.com/xumchain/go-xumchain/eth/downloader"
	"github.com/xumchain/go-xumchain/eth/ethconfig"
	"github.com/xumchain/go-xumchain/eth/gasprice"
	"github.com/xumchain/go-xumchain/eth/tracers"
	"github.com/xumchain/go-xumchain/ethdb"
	"github.com/xumchain/go-xumchain/ethstats"
	"github.com/xumchain/go-xumchain/graphql"
	"github.com/xumchain/go-xumchain/internal/ethapi"
	"github.com/xumchain/go-xumchain/internal/flags"
	"github.com/xumchain/go-xumchain/les"
	"github.com/xumchain/go-xumchain/log"
	"github.com/xumchain/go-xumchain/metrics"
	"github.com/xumchain/go-xumchain/metrics/exp"
	"github.com/xumchain/go-xumchain/metrics/influxdb"
	"github.com/xumchain/go-xumchain/miner"
	...
	"github.com/xumchain/go-xumchain/p2p/netutil"
...
// RegisterEthService adds an Xumchain client to the stack.
...
func RegisterEthService(stack *node.Node, cfg *ethconfig.Config) (ethapi.Backend, *eth.Ethereum) {
	if cfg.SyncMode == downloader.LightSync {
		...
		if err != nil {
			Fatalf("Failed to register the Xumchain service: %v", err)
		}
...
// RegisterEthStatsService configures the Xumchain Stats daemon and adds it to
// the given node.
func RegisterEthStatsService(stack *node.Node, backend ethapi.Backend, url string) {
	if err := ethstats.New(stack, backend, backend.Engine(), url); err != nil {
		Fatalf("Failed to register the Xumchain Stats service: %v", err)
	}
}
