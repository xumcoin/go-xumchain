...
import (
	...
	"github.com/xumchain/go-xumchain/eth/catalyst"
...
// makeFullNode loads geth configuration and creates the Xumchain backend.
func makeFullNode(ctx *cli.Context) (*node.Node, ethapi.Backend) {
	...
	// Add the Xumchain Stats daemon if requested.
	if cfg.Ethstats.URL != "" {
