...
type wizard struct {
	...
	services map[string][]string   // Xumchain services known to be running on servers
...
// converts it to an Xumchain address. If an empty line is entered, the default
// value is returned.
