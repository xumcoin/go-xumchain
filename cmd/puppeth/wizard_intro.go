...
// setting up a new or managing an existing Xumchain private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Xumchain private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Xumchain network down to  |")
	...
	log.Info("Administering Xumchain network", "name", w.network)
