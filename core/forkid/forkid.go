...
// NewID calculates the Xumchain fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Xumchain fork ID from an existing chain instance.
