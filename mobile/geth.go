...
import (
	...
	"github.com/xumchain/go-xumchain/internal/debug"
...
type NodeConfig struct {
	...
	// EthereumEnabled specifies whether the node should run the Xumchain protocol.
	EthereumEnabled bool

	// EthereumNetworkID is the network identifier used by the Xumchain protocol to
...
// Node represents a Geth Xumchain node instance.
type Node struct {
	node *node.Node
}
...
func NewNode(datadir string, config *NodeConfig) (stack *Node, _ error) {
	...
	// Register the Xumchain protocol if requested
...
// GetEthereumClient retrieves a client to access the Xumchain subsystem.
