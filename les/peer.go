...
import (
	...
	"github.com/xumchain/go-xumchain/les/utils"
...
type PeerInfo struct {
	Version    int      `json:"version"`    // Xumchain protocol version negotiated
...
// participating in the Light Xumchain sub-protocol.
